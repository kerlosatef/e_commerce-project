        ...
        <div class="product-detail-card">
            <div class="product-detail-layout">
                <div class="product-detail-image-wrapper">
                    <img class="product-detail-image" src="photo/woman.jpg" alt="Product 1 Large Image"
                        onerror="this.src='https://placehold.co/600x400/e2e8f0/cbd5e0?text=Image+Not+Found'">
                </div>
                <div class="product-detail-info">
                    <h1 class="product-detail-title">ZW COLLECTION HIGH-WAIST PALAZZO JEANS</h1>
                    <p class="product-detail-description">
                        High-waist jeans with belt loops at the waist. Five pockets. Wide
                        leg. Front zip and button fastening.
                        <br><br>



                    </p>
                    <p class="product-detail-price">3,290 EGP</p>
